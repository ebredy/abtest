...
$headliner = $this->abtest->getVariation('headliner');
  ...
  $tests = ['TEST_PAGES' => [
      ...
      '5-3mrf' => [
          'traffic_percentage' => 10, 'template_folder' => '5-3mrf', 'TYPE' => 'UPFRONT', 'PLATFORM' => 'DESKTOP', 'web_promotion_id' => 2468097531
      ], '10-6mrf' => [
          'traffic_percentage' => 90, 'template_folder' => '10-6mrf', 'TYPE' => 'UPFRONT', 'PLATFORM' => 'DESKTOP', 'web_promotion_id' => 1357908642
      ]
  ]];   
